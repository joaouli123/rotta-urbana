    ...
    <div style="max-width:1300px; margin:0 auto; display:flex; flex-wrap:wrap; gap:clamp(28px,4vw,56px); align-items:stretch;">
      <div style="flex:1 1 320px; min-width:min(100%,280px); display:flex; flex-direction:column; gap:18px;">
        ...
        <div style="display:flex; flex-direction:column; gap:12px; margin-top:6px;">
          <a href="https://wa.me/5566999309019" target="_blank" rel="noopener" style="display:flex; align-items:flex-start; gap:12px; text-decoration:none;" style-hover="opacity:0.8;">
            ...
            <span style="display:block;"><span style="display:block; font-family:'Sora',sans-serif; font-weight:700; font-size:15px; color:#0B0C0D;">WhatsApp</span><span style="display:block; font-family:'Inter',sans-serif; font-size:14px; line-height:1.5; color:#646A64;">(66) 99930-9019</span></span>
          </a>
          <a href="https://wa.me/5566996795065" target="_blank" rel="noopener" style="display:flex; align-items:flex-start; gap:12px; text-decoration:none;" style-hover="opacity:0.8;">
            <span style="width:42px; height:42px; border-radius:11px; background:#F7F8F6; display:flex; align-items:center; justify-content:center; flex:0 0 42px;"><img src="https://api.iconify.design/simple-icons/whatsapp.svg?color=%23279A0A&width=20" alt="" style="width:20px; height:20px; display:block;" /></span>
            <span style="display:block;"><span style="display:block; font-family:'Sora',sans-serif; font-weight:700; font-size:15px; color:#0B0C0D;">WhatsApp</span><span style="display:block; font-family:'Inter',sans-serif; font-size:14px; line-height:1.5; color:#646A64;">(66) 99679-5065</span></span>
          </a>
          <a href="mailto:rottaurbana.sinop@gmail.com" target="_blank" rel="noopener" style="display:flex; align-items:flex-start; gap:12px; text-decoration:none;" style-hover="opacity:0.8;">
            ...
            <span style="display:block;"><span style="display:block; font-family:'Sora',sans-serif; font-weight:700; font-size:15px; color:#0B0C0D;">E-mail</span><span style="display:block; font-family:'Inter',sans-serif; font-size:14px; line-height:1.5; color:#646A64;">rottaurbana.sinop@gmail.com</span></span>
          </a>
          ...
          <a href="https://www.google.com/maps/search/?api=1&query=Rua+das+Primaveras+5383+Jardim+Primavera+Sinop+MT" target="_blank" rel="noopener" style="display:flex; align-items:flex-start; gap:12px; text-decoration:none;" style-hover="opacity:0.8;">
            ...
            <span style="display:block;"><span style="display:block; font-family:'Sora',sans-serif; font-weight:700; font-size:15px; color:#0B0C0D;">Endereço</span><span style="display:block; font-family:'Inter',sans-serif; font-size:14px; line-height:1.5; color:#646A64;">Rua das Primaveras, 5383 — Jardim Primavera, Sinop/MT</span></span>
          </a>
        </div>
      </div>
    ...
    <div style="max-width:1300px; margin:0 auto; display:grid; grid-template-columns:repeat(auto-fit,minmax(200px,1fr)); gap:clamp(28px,4vw,44px); padding-bottom:40px; border-bottom:1px solid #1A1C1F;">
      <div style="display:flex; flex-direction:column; gap:16px;">
        ...
        <div style="display:flex; gap:10px; margin-top:4px;">
          ...
          <a href="https://wa.me/5566999309019" target="_blank" rel="noopener" aria-label="WhatsApp (66) 99930-9019" style="width:44px; height:44px; border-radius:50%; border:1px solid #232527; display:flex; align-items:center; justify-content:center; text-decoration:none;" style-hover="border-color:#48D10A;"><img src="https://api.iconify.design/simple-icons/whatsapp.svg?color=%2363F21B&width=19" alt="" style="width:19px; height:19px; display:block;" /></a>
          <a href="https://wa.me/5566996795065" target="_blank" rel="noopener" aria-label="WhatsApp (66) 99679-5065" style="width:44px; height:44px; border-radius:50%; border:1px solid #232527; display:flex; align-items:center; justify-content:center; text-decoration:none;" style-hover="border-color:#48D10A;"><img src="https://api.iconify.design/simple-icons/whatsapp.svg?color=%2363F21B&width=19" alt="" style="width:19px; height:19px; display:block;" /></a>
          <a href="mailto:rottaurbana.sinop@gmail.com" aria-label="E-mail" style="width:44px; height:44px; border-radius:50%; border:1px solid #232527; display:flex; align-items:center; justify-content:center; text-decoration:none;" style-hover="border-color:#48D10A;"><img src="https://api.iconify.design/lucide/mail.svg?color=%2363F21B&width=19" alt="" style="width:19px; height:19px; display:block;" /></a>
        </div>
      </div>
      ...
      <div style="display:flex; flex-direction:column; gap:14px;">
        ...
        <a href="mailto:rottaurbana.sinop@gmail.com" style="display:flex; align-items:center; gap:9px; font-family:'Inter',sans-serif; font-size:14px; color:#8A9088; text-decoration:none;" style-hover="color:#63F21B;"><img src="https://api.iconify.design/lucide/mail.svg?color=%23646A64&width=16" alt="" style="width:16px; height:16px; display:block;" />rottaurbana.sinop@gmail.com</a>
        <a href="https://wa.me/5566999309019" target="_blank" rel="noopener" style="display:flex; align-items:center; gap:9px; font-family:'Inter',sans-serif; font-size:14px; color:#8A9088; text-decoration:none;" style-hover="color:#63F21B;"><img src="https://api.iconify.design/simple-icons/whatsapp.svg?color=%23646A64&width=16" alt="" style="width:16px; height:16px; display:block;" />(66) 99930-9019</a>
        <a href="https://wa.me/5566996795065" target="_blank" rel="noopener" style="display:flex; align-items:center; gap:9px; font-family:'Inter',sans-serif; font-size:14px; color:#8A9088; text-decoration:none;" style-hover="color:#63F21B;"><img src="https://api.iconify.design/simple-icons/whatsapp.svg?color=%23646A64&width=16" alt="" style="width:16px; height:16px; display:block;" />(66) 99679-5065</a>
        ...
        <span style="display:flex; align-items:flex-start; gap:9px; font-family:'Inter',sans-serif; font-size:14px; line-height:1.5; color:#8A9088;"><img src="https://api.iconify.design/lucide/map-pin.svg?color=%23646A64&width=16" alt="" style="width:16px; height:16px; display:block; flex:0 0 16px; margin-top:3px;" />Rua das Primaveras, 5383 — Jardim Primavera, Sinop/MT</span>
      </div>
    </div>

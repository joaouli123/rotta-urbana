...
<style>
  ...
  *{box-sizing:border-box} body{margin:0;font-family:'Inter',system-ui,-apple-system,sans-serif;background:var(--bg);color:var(--txt);-webkit-font-smoothing:antialiased}
  ...
  .lead-message-preview{display:block;max-width:280px;padding:0;border:0;background:transparent;color:var(--txt);font:inherit;text-align:left;cursor:pointer;white-space:normal;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}
  .lead-message-preview:hover{color:var(--pri-dark);text-decoration:underline}
  .lead-message-cell{display:flex;flex-direction:column;align-items:flex-start;gap:5px;min-width:190px}.lead-message-open{padding:0;border:0;background:transparent;color:var(--pri-dark);font:600 11px inherit;cursor:pointer}.lead-message-open:hover{text-decoration:underline}
  body.modal-open{overflow:hidden}.lead-modal{position:fixed;inset:0;z-index:100;display:grid;place-items:center;padding:24px}.lead-modal[hidden]{display:none}.lead-modal-backdrop{position:absolute;inset:0;background:rgba(15,23,42,.48)}.lead-modal-card{position:relative;width:min(680px,100%);max-height:min(80vh,620px);overflow:auto;background:#FFF;border:1px solid var(--line);border-radius:18px;box-shadow:0 24px 70px rgba(15,23,42,.24)}.lead-modal-head{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:18px 22px;border-bottom:1px solid var(--line)}.lead-modal-head h2{margin:0;font-size:17px}.lead-modal-close{border:0;background:#F1F5F9;color:var(--txt);border-radius:9px;width:32px;height:32px;font-size:22px;line-height:1;cursor:pointer}.lead-modal-body{padding:22px;white-space:pre-wrap;overflow-wrap:anywhere;color:#334155;font-size:14px;line-height:1.65}
